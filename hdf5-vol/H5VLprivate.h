...
// Added by Dimos for the Retro BDB plugin
H5_DLL hid_t H5VL_RetroBDB_register(H5I_type_t type, void *obj, hbool_t app_ref);
H5_DLL herr_t H5VL_REetroBDB_unregister(hid_t obj_id);
